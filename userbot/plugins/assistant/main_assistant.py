...
async def ebackme(event):
    await event.edit(f"𝐇𝐞𝐥𝐥𝐨, {firstname} ! 𝐍𝐢𝐜𝐞 𝐓𝐨 𝐌𝐞𝐞𝐭 𝐘𝐨𝐮, /n/n𝐜𝐡𝐞𝐜𝐤 𝐡𝐞𝐫𝐞 𝐡𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐲𝐨𝐮𝐫 𝐨𝐰𝐧 𝐓𝐚𝐦𝐢𝐥𝐔𝐬𝐞𝐫𝐁𝐨𝐭:",
                     buttons=[
                         [(custom.Button.inline("ᴅᴇᴘʟᴏʏ ʏᴏᴜʀ ᴛᴀᴍɪʟᴜꜱᴇʀʙᴏᴛ", data="deploy")),
                          (Button.url("ᴜᴘᴅᴀᴛᴇꜱ", "t.me/TamilUserBot"))],
                         [Button.url("ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ",
                                     data="TamilSupport")]
                     ])
...
async def settings(event):
    await event.edit("𝐜𝐥𝐢𝐜𝐤 𝐛𝐞𝐥𝐨𝐰 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐭𝐨 𝐠𝐞𝐭 𝐭𝐮𝐭𝐨𝐫𝐢𝐚𝐥 𝐟𝐨𝐫 𝐡𝐞𝐫𝐨𝐤𝐮 𝐚𝐧𝐝 𝐫𝐚𝐢𝐥𝐰𝐚𝐲:",
                     buttons=[
                         [(Button.url("ʜᴇʀᴏᴋᴜ", "https://www.youtube.com/watch?v=3PgBiFgfx34")),
